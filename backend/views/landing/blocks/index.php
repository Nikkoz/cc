...
/* @var $blocks \core\entities\landing\Blocks[] */
/* @var $model \core\forms\manage\landing\blocks\BlocksForm */
/* @var $selected \core\entities\landing\Blocks */
/* @var $dataProvider \core\entities\landing\Elements */

$this->title = \Yii::t('app', 'Landing blocks');
$this->params['breadcrumbs'][] = $this->title;
?>
<div class="row blocks__update">
    <div class="col-md-3">
        <div class="box box-solid">
            <div class="box-header with-border">
                <div class="box-title">Блоки</div>
            </div>
            <div class="box-body no-padding limit-height">
                <ul class="nav nav-pills nav-stacked">
                    <?php foreach($blocks as $i => $block) : ?>
                        <li<?= $i == $selected->id ? ' class="active"' : '';?>>
                            <?= Html::a($block->name, ['form', 'id' => $block->id],['class' => 'blocks-btn_update']);?>
                        </li>
                    <?php endforeach;?>
                </ul>
            </div>
    ...
    <div class="col-md-9">
        <?php Pjax::begin(['id' => 'pjax-blocks', 'enablePushState' => false]);?>

        <div class="box box-success">
            <?php $form = ActiveForm::begin([
                'action' => "/landing/blocks/update/{$selected->id}",
                'options' => [
                    'class' => 'form-blocks',
                    'data-pjax' => true
                ]
            ...
            <div class="box-header">
                <div class="box-title"><?= $selected->name; ?></div>
            </div>
        ...
        <?php if(!in_array($selected->id, [1, 3 ,5])) :
            $columns = [
                ...
                <div class="col-md-12">
                    <div class="box box-info">
                        <div class="box-header">
                            <div class="row">
                                <div class="col-md-4">
                                    <?= Html::a(\Yii::t('app', 'Create'), ['create-settings','block_id'=>$selected->id], ['class' => 'btn btn-success','data-pjax'=>0]) ?>
                                </div>
                            </div>
                        </div>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="box box-info">
                        ...
                        <div class="box-body table__scroll table_third_blocks">
                            <?= GridView::widget([
                                'dataProvider' => $dataProvider,
                                'columns' => [
                                    ['class' => 'yii\grid\SerialColumn'],
