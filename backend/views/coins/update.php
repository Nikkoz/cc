...
/* @var $model core\forms\manage\coins\CoinsEditForm */
/* @var $form yii\widgets\ActiveForm */
/* @var $coin \core\entities\coins\Coins */

$this->title = \Yii::t('app', 'Edit Coin') . ' ' . $model->name;
                ...
                <div class="row">
                    ...
                    <?= $form->field($model->picture, 'file', ['options' => ['class' => 'col-md-6']])->widget(\kartik\file\FileInput::class, [
                        ...
                        'pluginOptions' => [
                            ...
                            'initialPreview' => [
                                $coin->picture ? $coin->picture->getFile('coins') : ''
                            ],
                            'initialPreviewConfig' => $coin->picture ? [
                                [
                                    'caption' => '',
                                    'url' => "/coins/remove-picture/?id={$model->id}",
                                    'key' => $model->picture->file->id,
                                    'extra' => [
                                        'id' => $model->picture->file->id,
                                    ]
                                ]
                            ] : [],
