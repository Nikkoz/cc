...
$page_name = str_replace('https://twitter.com/', '', $model->page_name)
?>
    ...
    <div class="col-md-6">
        <div class="box box-primary">
            <div class="box-header with-border">
                ...
                <?php if ($is != 'create'): ?>
                    <div class="post_link">(<?= Html::a('Посмотреть', Url::to("https://twitter.com/{$page_name}/status/{$model->post_id}"), ['target' => '_blank'])?>)</div>
                <?php endif;?>
            </div>
            <div class="box-body">
