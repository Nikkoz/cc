...
class CZycrypto(Main):
    ...
    def get_news(self):
        ...
        wrapper = soup.find('div', {'class': 'tdc-content-wrap'})

        try:
            inner = wrapper.find_all('div', {'class': 'tdc-row'})
            blocks = inner[1].find_all('div', {'class': 'td-block-span4'})
