 ...
 */
class Twitter extends PostEntities
{
    public static function create(int $post_id, int $coin_id, string $text, string $created): self
    {
        $post = new static();
    ...
    public function edit(int $post_id, int $coin_id, string $text, string $created): void
    {
